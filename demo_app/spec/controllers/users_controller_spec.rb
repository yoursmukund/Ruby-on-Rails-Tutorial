...
describe 'authentication when edit/update' do
	before(:each) do
		@user = Factory(:user)
	end
	...
	describe "for signed in users" do
		before(:each) do
			wrong_user = Factory(:user, :email => "invalid@email.com")
			test_sign_in(wrong_user)
		end
		it "should check correct user for edit" do
			get :edit, :id => @user
			response.should redirect_to(root_path)
		end
		it "should check correct user for update" do
